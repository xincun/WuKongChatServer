...
import (
	...
	"github.com/WuKongIM/WuKongChatServer/pkg/cache"
	...
	"github.com/WuKongIM/WuKongChatServer/pkg/redis"
...
func NewContext(cfg *Config) *Context {
	userIDGen, err := snowflake.NewNode(int64(cfg.NodeID))
	if err != nil {
		panic(err)
	}
	c := &Context{
...
func (c *Context) NewMySQL() *dbr.Session {
	...
	if c.mySQLSession == nil {
		c.mySQLSession = db.NewMySQL(c.cfg.MySQLAddr, c.cfg.SQLDir, c.cfg.Migration)
	}
